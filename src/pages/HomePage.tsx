...
const StarIcon = () => (
 <svg
    ...
    >
      <path
        d="M0.200195 5.54004V11.5713L4.80957 6.86426V0.515625L0.200195 5.54004Z"
        fill="white"
        stroke="white"
        strokeWidth={0.4}
      />
      <path
        d="M5.20996 6.88086L9.59277 11.5566V5.53711L5.20996 0.52832V6.88086Z"
        fill="white"
        stroke="white"
        strokeWidth={0.4}
      />
      <path
        d="M0.200195 13.9531V15.5098L4.80957 10.8027V9.19238L0.200195 13.9531Z"
        fill="white"
        stroke="white"
        strokeWidth={0.4}
      />
      <path
        d="M5.20996 10.8184L9.59277 15.4941V13.9482L5.20996 9.24219V10.8184Z"
        fill="white"
        stroke="white"
        strokeWidth={0.4}
      />
...
const WalletIllustration = () => (
   <svg
      ...
      width="100"
      height="120"
      viewBox="155 200 85 110"
      fill="none"
    >
      <path
        opacity={0.5}
        d="M162.288 249.239H228.208C229.238 249.239 229.893 249.947 229.893 250.611V290.438C229.893 295.771 224.897 300.263 218.511 300.263H162.288C161.258 300.263 160.604 299.555 160.604 298.891V250.611C160.604 249.947 161.258 249.239 162.288 249.239Z"
        fill="url(#p0)"
        stroke="url(#p1)"
        strokeWidth={1.5}
      />
      <path
        d="M159.277 249.494H225.953C226.775 249.494 227.261 250.054 227.261 250.537V291.022C227.261 296.173 222.433 300.518 216.256 300.518H159.277C158.456 300.518 157.971 299.958 157.971 299.475V250.537C157.971 250.054 158.456 249.494 159.277 249.494Z"
        fill="url(#p2)"
        stroke="url(#p3)"
        strokeWidth={1.5}
      />
      ...
      <path
        d="M218.455 268.746H232.655C233.345 268.746 233.905 269.305 233.905 269.996V279.304C233.905 279.994 233.345 280.554 232.655 280.554H218.455C215.498 280.554 213.021 277.986 213.021 274.716V274.583C213.022 271.314 215.498 268.746 218.455 268.746Z"
        fill="url(#p4)"
        stroke="url(#p5)"
        strokeWidth={1.5}
        strokeLinejoin="round"
      ...
      <defs>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#3B18DE" />
          <stop offset="1" stopColor="#C2FF0A" stopOpacity={0.9} />
        </linearGradient>
        <linearGradient
          id="p1"
          x1="195.248"
